...
int handle_sepolicy(unsigned long arg3, void __user *arg4)
{
	...
	if (unlikely(ksu_is_compat)) {
		...
		sepol1 = (void *)data.field_sepol1;
		sepol2 = (void *)data.field_sepol2;
		sepol3 = (void *)data.field_sepol3;
		sepol4 = (void *)data.field_sepol4;
		sepol5 = (void *)data.field_sepol5;
		sepol6 = (void *)data.field_sepol6;
		sepol7 = (void *)data.field_sepol7;
		cmd = data.cmd;
		subcmd = data.subcmd;
	}
#else 
